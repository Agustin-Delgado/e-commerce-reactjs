            ...
            <nav className="header__navbar">
                ...
                <ul className="header__navbar-list">
                    ...
                    <li className="header__navbar-list-item">
                        ...
                        <a className="header__navbar-list-item-title">Inicio</a>

                    </li>

                    <li className="header__navbar-list-item">

                        <a className="header__navbar-list-item-title">Favoritos <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                    ...
                    <li className="header__navbar-list-item">
                        ...
                        <a className="header__navbar-list-item-title">
